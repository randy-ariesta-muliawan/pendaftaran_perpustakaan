...
def tampilan_mencari_buku(name):
	system("cls")
...
def edit_info():
	...
	if result:
		print("EDIT [1] NAMA, [2] TANGGAL PENGEMBALIAN, [3] NAMA BUKU, [4] NOMOR TELEPON, [5] ALAMAT RUMAH")
...
def cek_respon_user(char):
	if char == "1":
		...
		tampilan_mencari_buku()
	elif char == "4":
		menghapus_buku_dari_daftar()
	elif char == "5":
		edit_info()
	elif char == "6":
		tentang_kami()
...
nama = {
	'Udin' : {
		'tanggal_pengembalian' : '20 Oktober 2021',
		'nama_buku' : 'Koleksi Pantun',
		'telp_peminjam_buku' : '0812',
		'alamat_peminjam_buku' : 'Kenten'
	},
	'Joko' : {
		'tanggal_pengembalian' : '20 Oktober 2021',
		'nama_buku' : 'Koleksi Pantun',
